...
"acknowledge1":["Fantastic.  Lets get started.  First, you need to take me to the hallway in front of the information desk.  If anywhere has a good Why Figh signal, I would expect it to be them for sure.  Press the green button and lets go!","Take me to the info desk? Press the the {GREEN, fg=white, bg=green} button if yes, {RED, fg=white, bg=red} if no."],
"transit1":["Please press the green button again when we arrive.", "Press the {GREEN, fg=white, bg=green} button when we arrive."],
...
"transit2":["One time I met someone who refused to take me to my second destination.  I could not understand why.  My work is important, both for robots and humans.  Its in everyones best interest that they assist me.","Press the {GREEN, fg=white, bg=green} button when we arrive."],
"acknowledge3":["Ok, we have one more stop to complete.  I would like you to take me to the chairs at the top of the nearby staircase.  Sometimes students study there.  Press the green button and lets go!","Take me up the stairs? Press the {GREEN, fg=white, bg=green} button if yes, {RED, fg=white, bg=red} if no."],
"transit3":["While we have been walking I have written and submitted three publications already.  These data are great.  Never mind what it actually says,,, it might be a bit complicated for you.  Just keep walking.","Press the {GREEN, fg=white, bg=green} button when we arrive."],
...
"redButton":["You don’t want to help me anymore?  Aww, that’s so disappointing, but I understand.  Have a nice day!","Please leave me for someone else to find."]}
